...
class SplashView(QWidget):
    ...
    def paintEvent(self, event) -> None:
        ...
        paint_menu_art(self, painter, left_vignette=False, dim=0.28)
        painter.end()
    ...
    def retranslate(self) -> None:
        self.stage.setText(t(self._stage_key))

    def set_stage(self, text: str) -> None:
        self._stage_key = text if text in ("initializing", "scanning_aircraft") else text
        self.stage.setText(t(text) if text in ("initializing", "scanning_aircraft") else text)
